...
export default function TeamMemberCard({
  ...
  return (
    <div
      ...
      className={[
        "team-card group/team relative isolate flex h-full min-h-[22rem] flex-col overflow-hidden rounded-2xl transition-all duration-500 ease-out cursor-pointer select-none",
        isHighlight
