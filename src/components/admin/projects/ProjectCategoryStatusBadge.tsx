import type { ProjectCategoryStatus } from "@/types/project";

const toneMap: Record<ProjectCategoryStatus, string> = {
  active: "border-emerald-500/30 bg-emerald-500/10 text-emerald-700",
  inactive: "border-amber-400/40 bg-amber-400/10 text-amber-700",
  archived: "border-muted-foreground/20 bg-muted text-muted-foreground",
};

export default function ProjectCategoryStatusBadge({
  status,
}: {
